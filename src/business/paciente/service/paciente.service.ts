...
import { IPacienteServicio } from './paciente.service.interface';
import * as obraSocialRepositoryInterface from '../../../../src/persistence/obra-social/obra.social.repository.interface';
import * as patientRepositoryInterface from '../../../../src/persistence/paciente/patient.repository.interface';
...
export class PacienteServicio implements IPacienteServicio {
  constructor(
    ...
    @Inject(patientRepositoryInterface.PACIENTE_REPOSITORIO)
    private readonly patientRepo: patientRepositoryInterface.IPacienteRepositorio,
  ) {}
